...
|  3 |   |   |                   |           |         |         |      |       |        |     |       |             |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+--------+-----+-------+-------------+
|  4 |   |   |   | countries     | COUNTRIES |         |         | id   |       |        |     |       |             |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+--------+-----+-------+-------------+
|  5 |   |   |   |   | id        | id        |         | integer |      | 4     |        |     |       |             |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+--------+-----+-------+-------------+
|  6 |   |   |   |   | code      | code      |         | string  |      | 2     |        |     |       |             |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+--------+-----+-------+-------------+
|  7 |   |   |   |   | name      | country   |         | string  |      | 2     |        |     |       |             |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+--------+-----+-------+-------------+
...
| id | d | r | b | m | property  | source    | prepare | type    | ref  | level | access  | uri                   | title        | description     |
+====+===+===+===+===+===========+===========+=========+=========+======+=======+=========+=======================+==============+=================+
|  1 | datasets/gov/dc/countries |           |         |         |      |       |         |                       | Šalys        |                 |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+---------+-----------------------+--------------+-----------------+
|  2 |   | sql                   |           |         |         |      |       |         |                       | Duomenų bazė |                 |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+---------+-----------------------+--------------+-----------------+
|  3 |   |   | /country          |           |         |         | code |       |         |                       |              |                 |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+---------+-----------------------+--------------+-----------------+
|  4 |   |   |   | countries     | COUNTRIES |         |         | id   |       |         | schema:Country        | Šalis        |                 |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+---------+-----------------------+--------------+-----------------+
|  5 |   |   |   |   | id        | id        |         | integer |      | 5     | private |                       |              |                 |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+---------+-----------------------+--------------+-----------------+
|  6 |   |   |   |   | code      | code      |         | string  |      | 5     | open    | esco:isoCountryCodeA2 | Šalies kodas | Dviejų simbolių |
|    |   |   |   |   |           |           |         |         |      |       |         |                       |              | šalies kodas    |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+---------+-----------------------+--------------+-----------------+
|  7 |   |   |   |   | name      | country   |         | string  |      | 5     | open    | og:country-name       | Pavadiniams  |                 |
+----+---+---+---+---+-----------+-----------+---------+---------+------+-------+---------+-----------------------+--------------+-----------------+
...
|  1 |                  |        |         |        |     |       |        |                       |                     |             |
+----+---+---+----------+--------+---------+--------+-----+-------+--------+-----------------------+---------------------+-------------+
|  2 |   | country      |        |         |        |     |       |        | schema:Country        | Šalis               |             |
+----+---+---+----------+--------+---------+--------+-----+-------+--------+-----------------------+---------------------+-------------+
|  3 |   |   | code     |        |         | string |     |       |        | esco:isoCountryCodeA2 | ISO 3166-1 A2 kodas |             |
+----+---+---+----------+--------+---------+--------+-----+-------+--------+-----------------------+---------------------+-------------+
|  4 |   |   | name     |        |         | string |     |       |        | og:country-name       | Pavadinimas         |             |
+----+---+---+----------+--------+---------+--------+-----+-------+--------+-----------------------+---------------------+-------------+
