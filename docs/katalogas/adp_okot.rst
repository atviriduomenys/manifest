...
*Būsite nukreipti į El.Vartų puslapį.* *Čia pateikiami prisijungimo
būdai:*
...
- Valstybės tarnautojas: Registruokitės pasirinkę „Gyventojas“ arba
   „Viešasis sektorius“
...
| |Graphical user interface, application Description automatically
  generated|
| 3 pav. El.Vartų puslapio viršutinis fragmentas

2. Atsidariusiame lange pasirinkite registraciją „Per banką“ arba „Su
   elektroninės atpažinties priemone“.

   *Siūlome rinktis variantą „Per banką“.*

| |Table Description automatically generated|
| 4 pav. Prisijungimo prie El.Vartų langas

3. Pasirinkite registraciją „Per banką“, paspauskite savo banko ikoną,
   suvesti el. bankininkystės prisijungimo duomenis.
...
| |Graphical user interface, application Description automatically
  generated|
| 5 pav. El.Vartų prisijungimo tapatybės nustatymo langas

2. Atsidariusiame lange spauskite „Valstybės tarnautojo pažymėjimas ir
   skaitytuvas“.
...
- *Nuo*\ **Varianto (A)**\ *, jeigu buvote nukreipti į puslapį
   „E-paslaugos“,*

- *Nuo*\ **Varianto (B)**\ *, jeigu buvote nukreipti „Duomenų teikimas
   į Atvirų duomenų portalą“.*
...
*Atsidarys El.Vartų langas „Duomenų teikimas į Atvirų duomenų portalą“:
čia automatiškai surenkami ir atvaizduojami registruojamo
...
5. Pateikite *organizacijos atvirų duomenų koordinatoriaus* informaciją
   (\* – privaloma):

- Organizaciją \*: pasirinkite iš sąrašo.

   Jeigu organizacijos nėra sąraše, spauskite [**Pridėti
   organizaciją**].
...
- Įkelkite institucijos vadovo (ar įgalioto darbuotojo) pasirašytą
   koordinatoriaus paskyrimo raštą \*.
...
1. Naršyklėje atidarykite puslapį adresu: https://data.gov.lt/login.
...
=============================================================================================
=========================================
|Graphical user interface, application Description automatically generated|                  *Pagrindinis meniu matomas prisijungus prie sistemos ir leidžia pasiekti aplinkos atributus:* 16 pav. Pagrindinis meniu Koordinatoriams
15 pav. Pagrindinis                                                                                                                                                                       
...
| |image21|
| 18 pav. Organizacijos koordinatoriaus aplinkos pradinio lango
  fragmentas
...
- **ID** – unikalus paskyros identifikatorius sistemoje. Galite
   ...
   tvarka spausdami rodykles **[**\ |image24|\ **]** prie stulpelio
   pavadinimo.
...
- **El. paštas** – el. paštas, kuriuo registruotos paskyros. Galima
   ...
   **[**\ |image25|\ **]** prie stulpelio pavadinimo.
...
- **Vardas**, **Pavardė** – paskyrų naudotojų vardų ir pavardžių
   ...
   **[**\ |image26|\ **]** prie kurio nors stulpelio pavadinimo.
...
- **Sukurtas** – paskyros sukūrimo data ir laikas. Galima rikiuoti nuo
   naujausios arba nuo seniausios datos spaudžiant
   **[**\ |image28|\ **]** prie stulpelio pavadinimo.

**Sukurti naują savo organizacijos AD tvarkytojo paskyrą:**

1. Spauskite **[+ Pridėti]** ir užpildykite registracijos langą ir
...
1. Sąraše pažymėkite reikiamą paskyrą ir lango meniu spauskite
   **[Redaguoti]**:
...
- Sąraše pažymėkite paskyrą ir spauskite **[Suspenduoti]**.
   ...
   *Atsidaro papildomas langas, kuriame pasirinkite naudotoją, kuriam
   bus priskirti duomenys:*
...
4. Įsitikinę, kad tinkamai užpildėte/redagavote laukus, spauskite
   **[**\ |image32|\ **]** lango apačioje.

5. Norėdami ištrinti pasirinktą organizaciją, spauskite [|image33|]
   lango apačioje.
...
1. Pagrindiniame meniu pasirinkite **„Atvėrimo poreikiai“;** du kartus
   paspauskite ant pasirinkto poreikio ir atsidarytų papildomas meniu
   „Atvėrimo poreikis“, pasirinkite „\ **Pageidaujama duomenų
   struktūra**\ “:
...
| |struk|
| 29 pav. Reikiamos duomenų struktūros failo atsisiuntimo nuoroda
  poreikio lange
...
| |poreik|
| 31 pav. Atvėrimo poreikio lango skilties „Organizacijos atsakymas“
  pavyzdys
...
*Jei duomenų rinkinys perkeliamas iš vienos organizacijos kitai, pirmoji
netenka prieigos prie jo.*
...
- **Viešas:** duomenų rinkinio vaizdavimo viešoje aplinkoje būsena. Jei
   pateiktas varnelė **[**\ |image46|\ **]**, rinkinys – pateiktas
   viešoje aplinkoje. Jei lauke pateiktas tuščias apskritimas
   [|image47|], rinkinys matomas tik administracinėje aplinkoje;
...
..
   ...
   **Aprašymas (anglų k.):** pilnas duomenų rinkinio aprašymas anglų
   kalba; *Jei pirma užpildysite lietuvišką lauką, sistema anglišką
   pavadinimą paruoš automatiškai;*
...
5. | |Graphical user interface Description automatically generated|
   | 34 pav. Išsaugotos kortelės *1. Inventorinimo duomenys“* sistemos
...
*SVARBU: Į Portalą vienam rinkiniui turi būti įkeliamas vienas duomenų
struktūros aprašas (DSA).*

*Galima įkelti kelias vieno rinkinio versijas, tačiau vienam rinkiniui
gali būti publikuojamas tik vienas DSA.*

1. Duomenų rinkinio lange spauskite lango meniu punktą **„2.
      Struktūra“**.
...
1. Pasirinkite reikiamą duomenų struktūros versiją ir spauskite
   [Padaryti aktualiu].

   *Sėkmingai atlikus veiksmą, sistema pažymės struktūrą stulpelyje
   „Aktualus“ su verte „Taip“.*

*Jeigu nesate įkėlę duomenų struktūros, gausite klaidos pranešimą:*

| |Text Description automatically generated with medium confidence|
| 37 pav. „Daryti aktualiu“ klaidos langas, kai nepateikta duomenų
  struktūra

2. Pasirinkite norimą pašalinti duomenų struktūros versiją ir spauskite
   [Šalinti failą].

   *Sėkmingai atlikus veiksmą, sistema pašalins pasirinktą struktūrą iš
   sąrašo.*
...
| |Graphical user interface, text, application, email, Teams Description
  automatically generated|
| 45 pav. Duomenų rinkinio metaduomenų įvedimo/redagavimo lango pirmas
  fragmentas

| |Graphical user interface, text, application Description automatically
  generated|
| 46 pav. Duomenų rinkinio metaduomenų įvedimo/redagavimo lango antras
  fragmentas
...
..
   ...
   Laukas netaisomas: nustatomas automatiškai, nurodant anksčiausią
   visuose įkeltuose rinkinio failuose periodo pradžios datą (nurodoma
   keliant duomenų failą).

   Neįkėlus nei vieno duomenų failo, laukas rodomas tuščias; nustatoma
   automatiškai.
...
- **Įvertinimas:** viešoje aplinkoje registruotų naudotojų pateiktas
      bendras rinkinio įvertinimas 5 balų skalėje;
...
..
   ...
   *Nustatoma automatiškai, priklausomai nuo to, kokia vėliausia periodo
   pabaiga nurodyta įkeltuose failuose.*
...
| |Graphical user interface, text, application, chat or text message
  Description automatically generated|
| 47 pav. Duomenų rinkinio metaduomenų įvedimo/redagavimo lango apatinis
  fragmentas

3. Užpildžius reikiamus laukus, galite spauskite mygtuką **[Saugoti]**
      arba pereikite prie kitų kortelių pildymo.
...
*Jei spaudžiate*\ **[Saugoti]**\ *neužpildę kai kurių privalomų laukų,
net jei jie buvo neužpildyti ir išsaugoti prieš Jums atsidarant
metaduomenų langą, sistema parodys papildomą langą, kuriame pateikiami
privalomi neužpildyti DCAT laukai.*
...
| |image64|
| 48 pav. Duomenų rinkinio metaduomenų neužpildymo paaiškinimo lango
  pavyzdys
...
5. Įvedę priežastis neužpildyti privalomiems laukams, spauskite
      **[Saugoti]**.

6. Spauskite **[Saugoti]** metaduomenų įvedimo lange, kad išsaugotumėte
...
51 pav. Duomenų rinkinio duomenų distribucijos langas
...
6. Jei distribuciją keliate kaip nuorodą, nuorodos įkėlimo lange vietoje
   suveskite papildomus privalomus laukus:
...
- **Viešas:** rinkinio viešumo portalo viešoje aplinkoje būsena. Laukas
      žymimas varnele **[**\ |image76|\ **]**, jei rinkinys – viešas;
...
1. Paspauskite ant IRS rinkinio, kurį norite peržiūrėti/ tikslinti/
   sutvarkyti eilutės:

| |image77|
| 60 pav. IRS rinkinių sąrašo langas

*SVARBU: IRS rinkinį reikia pašalinti, jeigu duomenų rinkinys nebėra
aktualus, arba jau yra įvesta naujas panašus duomenų rinkinys. IRS
rinkinius galima redaguoti. Tikslinant IRS rinkinius galioja tos pačios
taisyklės, kaip ir naujo duomenų rinkinio įvedimo atveju.*

*Tikslinant IRS rinkinius rekomenduotina pakeisti „5. Metaduomenų“ lauko
„Katalogas“ informaciją: iš „Duomenys iš IRS“ į „Lietuvos“. Atlikus šį
pakeitimą duomenų rinkinys bus matomas tik bendrame „Duomenų rinkiniai“
sąraše, o „IRS rinkiniai“ sąraše šio duomenų rinkinio nebus.*
...
*Skiltis*\ **„Istorija“**\ *tampa prieinama (tapusi prieinama patamsėja)
atlikus kokius nors veiksmus su planu.*

3. Pasirinkto metinio plano lange spauskite **[Formuoti <Jūsų pasirinkti
      metai> metų planą]**, esantį virš metinio duomenų atvėrimo plano
      lango poskyrių meniu.
...
..
   ...
   **Pastaba**\ *: į metinį planą įtrauktų duomenų rinkinių prioritetų
   ...
   išformavimas <#ataskaitų-formavimas>`__
...
2. Rinkinių įtraukimo lango apačioje spauskite mygtuką **[Išformuoti
   planą]**.
...
Planas tebeliks matomas planų sąraše ir jį bus galima formuoti iš naujo
įtraukiant rinkinius, tačiau jis bus tuščias, o jam buvę priskirti
rinkiniai nebebus jam priskirti ir juos bus galima priskirti kitiems
metiniams planams.
...
1. Paspauskite ant bet kurio stulpelio pavadinimo dešiniuoju pelės
   klavišu.

| |image90|
| 72 pav. Ataskaitos „Atvirų duomenų rinkinių naudojimo intensyvumo
...
- Jei stulpelio būsenos reikšmė yra pažymėta varnele
   **„**\ |image91|\ **“**, stulpelis rodomas ataskaitoje.

- Jei stulpelio būsenos reikšmė yra tuščia (**„**\ |image92|\ **“**).

   **Keisti stulpelio būseną:**

- Paspauskite būsenos ikoną: varnelę „\ |image93|\ “ arba tuščią lauką
   „\ |image94|\ “.
...
| |image95|
| 73 pav. Ataskaitos „Atvirų duomenų rinkinių naudojimo intensyvumo
...
| |image96|
| 74 pav. Ataskaitos „Atvirų duomenų rinkinių naudojimo intensyvumo
...
| |image97|
| 75 pav. Ataskaitos „Atvirų duomenų rinkinių naudojimo intensyvumo
  detalūs duomenys“ šablono keitimo lango fragmentas
...
2. Spustelėkite savo paskyros ikoną **[**\ |image99|\ **]** dešiniame
...
.. |Graphical user interface Description automatically generated| image:: /static/katalogas/okot/image3.png
   :width: 5.54178in
   :height: 3in
.. |Graphical user interface, text, application, email, website Description automatically generated| image:: /static/katalogas/okot/image4.png
   :width: 5.13873in
   :height: 1.8995in
.. |Graphical user interface, application Description automatically generated| image:: /static/katalogas/okot/image5.png
   :width: 1.60106in
   :height: 1in
.. |Table Description automatically generated| image:: /static/katalogas/okot/image6.png
   :width: 5in
   :height: 2.0858in
.. |Graphical user interface, application Description automatically generated| image:: /static/katalogas/okot/image7.png
   :width: 4.99732in
   :height: 0.94304in
.. |Graphical user interface, text, application Description automatically generated| image:: /static/katalogas/okot/image8.png
   :width: 1.19081in
   :height: 1in
.. |Graphical user interface, text, application Description automatically generated| image:: /static/katalogas/okot/image9.png
   :width: 2.68784in
   :height: 1.3in
.. |image9| image:: /static/katalogas/okot/image10.png
   :width: 1.58309in
   :height: 1.2in
.. |Graphical user interface, website Description automatically generated| image:: /static/katalogas/okot/image11.png
   :width: 6.6875in
   :height: 3.9375in
.. |image11| image:: /static/katalogas/okot/image12.png
   :width: 5in
   :height: 1.79317in
.. |Graphical user interface Description automatically generated| image:: /static/katalogas/okot/image3.png
   :width: 5.54178in
...
.. |image14| image:: /static/katalogas/okot/image14.png
   :width: 6in
   :height: 2.89505in
.. |Graphical user interface, text, application, email Description automatically generated| image:: /static/katalogas/okot/image15.png
   :width: 6in
   :height: 2.59508in
.. |Graphical user interface, application Description automatically generated| image:: /static/katalogas/okot/image16.png
   :width: 1.3in
   :height: 2.43671in
.. |Screenshot (254)| image:: /static/katalogas/okot/image18.png
   :height: 0.10556in
.. |image18| image:: /static/katalogas/okot/image19.png
...
.. |image45| image:: /static/katalogas/okot/image42.png
   :width: 6in
   :height: 0.8389in
.. |image46| image:: /static/katalogas/okot/image43.png
   :width: 0.15627in
   :height: 0.15in
.. |image47| image:: /static/katalogas/okot/image44.png
   :width: 0.15in
   :height: 0.15in
